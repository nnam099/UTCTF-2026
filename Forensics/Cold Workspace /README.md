...
1. Challenge Overview
    ...
    Description: A workstation crashed, and a critical desktop artifact disappeared. A memory snapshot was taken before the reboot. The goal is to recover the lost file.
...
Từ phân tích trên, mình xác định thuật toán sử dụng là AES-256-CBC. Tiếp tục truy vết trong file dump, mình thu được các chuỗi Base64 cần thiết:

    Ciphertext (ENCD): S4wX8ml7/f9C2ffc8vENqtWw8Bko1RAhCwLLG4vvjeT2iJ26nfeMzWEyx/HlK1KmOhIrSMoWtmgu2OKMtTtUXddZDQ87FTEXIqghzCL6ErnC1+GwpSfzCDr9woKXj5IzcU2C/Ft5u705bY3b6/Z/Q/N6MPLXV55pLzIDnO1nvtja123WWwH54O4mnyWNspt5
...
Sau khi giải mã thành công, mình kiểm tra nội dung file ảnh đã khôi phục:
Bash
